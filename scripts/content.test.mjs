...
test("pricing data exposes exact public offer rows and monthly schema semantics", async () => {
  ...
  for (const expectedTemplatesPageSignal of [
    ...
    "Hofladen Template",
    "Praxis Template",
    "Immobilienberatung Template",
    "Für Freelancer",
    "Für Studios",
    "Für Immobilienmakler",
    "Für Biohöfe",
    "Für Arztpraxen",
    "Für Immobilienberater",
  ...
  for (const expectedTemplateAsset of [
    ...
    "public/templates/stilles-kollektiv-template.webp",
    ...
    "public/templates/videos/stilles-kollektiv-template.mp4",
  ]) {
