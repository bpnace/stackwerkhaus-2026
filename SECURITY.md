...
- affected file, route, workflow, or configuration
- reproduction steps
- expected impact
- safe evidence that does not include secrets

Do not include live credentials, tokens, personal data, production payloads, or
private infrastructure details in public issues, forks, screenshots, or pull
requests.
